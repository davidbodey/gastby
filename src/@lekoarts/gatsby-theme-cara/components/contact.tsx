...
const Contact = ({ offset, factor = 1 }: { offset: number; factor?: number }) => (
  <div>
      ...
      <div sx={{ position: `absolute`, bottom: 0, width: `full`, transform: `matrix(1, 0, 0, -1, 0, 0)` }}>
        <div
          sx={{
            ...
            path: { animation: waveAnimation(`40s`) },
          }}
        >
    ...
    <Divider speed={0.1} offset={offset} factor={factor}>
      <UpDown>
        <Svg icon="box" hiddenMobile stroke width={8} color="icon_red" left="70%" top="20%" />
        <Svg icon="box" width={8} stroke color="icon_green" left="25%" top="5%" />
      </UpDown>
      <UpDownWide>
        <Svg icon="box" width={12} stroke color="icon_red" left="95%" top="50%" />
        <Svg icon="box" width={6} stroke color="icon_blue" left="85%" top="15%" />
